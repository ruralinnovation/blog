---
title: "2 cool uses of the cori.data.fcc package"
...
Turns out only **11.5%** of locations have fiber access in the Northeast Kingdom.
...
```{r f477}
# Pulling all Form 477 for teh state of Vermont
...
nek_bb_frn <- "0031871197" # This number can be find using cori.data.fcc::fcc_provider
...
# We could also have filtered before 
