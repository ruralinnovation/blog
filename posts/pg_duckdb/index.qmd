...
They are a lot of talks (righfully) on the use of [Apache Parquet](https://parquet.apache.org/), [Apache Arrow](https://arrow.apache.org/) and [DuckDB](https://duckdb.org/). Let's see an example on how they can be used to convert a table in a PostgresSQL database to a parquet file.
...
Here `state_abbr` and `technology` are good tradeoff by having good overall size of parquets file and fast access to reguraly needed data.
