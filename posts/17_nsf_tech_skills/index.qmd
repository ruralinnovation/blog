---
title: "'Tech Deserts' in the Digital Age"
...
fig <-  ggplot() +
  ...
  geom_sf(data = map_dta, aes(fill = factor(tech_hub_co_ord7)), 
          color = "grey60", 
          size = 0.05, 
          show.legend = TRUE) +
...
fig <- ggplot() +
  geom_sf(data = us_map, color = "black", fill = "grey95", linewidth = 0.05) +
  geom_sf(data = rural_map_dta, aes(fill = factor(tech_hub_co_ord7)), 
          color = "grey60", 
          size = 0.05, 
          show.legend = TRUE) +
  cori.charts::theme_cori_map() +
...
fig <- ggplot() +
  geom_sf(data = us_map, color = "black", fill = "grey95", linewidth = 0.05) +
  geom_sf(data = select_states_dta, aes(fill = factor(tech_hub_co_ord7)), 
          color = "grey", 
          size = 0.05, 
          show.legend = TRUE) +
  cori.charts::theme_cori_map() +
