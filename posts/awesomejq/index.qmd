...
Not quoting it would mean that we have 4 arguments when you just have 2.
...
Here we asked for the [0 to 5[ (yes: `[inclusive:exclusive]`) features (i.e. the first 5) and it produces a valid JSON but if you inspect it you will see that we moved from the GeoJON to a JSON array. 
