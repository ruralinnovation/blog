...
It is not a deaply nested JSON but it is perfect to illustrate some very communs use cases.
...
We have just explored the surface: `jq` can help to filter some specific features (every geometries "served" in our file, the first node in every geometries)
